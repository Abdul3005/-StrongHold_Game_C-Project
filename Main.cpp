...
void initializeGame(Peasant& peasants, Merchant& merchants, Noble& nobles,
    ...
    cout << "Game initialized with the following settings:\n";
    ...
    cout << "Resources - Food: " << INITIAL_FOOD << ", Wood: " << INITIAL_WOOD
...
void populationManagementMenu(Population& pop, Resources& res) {
    static int shelterCapacity = 600; 
    int choice;

    do {
        cout << "\n=== POPULATION MANAGEMENT ===" << endl;
        ...
        case 1: {
            if (res.consumeWood(50) && res.consumeStone(30)) {
                ...
                cout << "Built housing for 100 more people!\n";
            }
            else {
...
void displayMainMenu() {
    cout << "\n=== STRONGHOLD KINGDOM MANAGER ===" << endl;
...
void processMonth(Population& pop, Army& army, Economy& econ,
    ...
    shelterCapacity += possibleHousing * 100;
    ...
    cout << "\nShelter Capacity: " << shelterCapacity;
    cout << "\nPress Enter to continue...";
    cin.ignore();
    cin.get();
    system("cls");
