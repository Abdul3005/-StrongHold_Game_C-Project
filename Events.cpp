...
EventType KingdomEvent::getRandomEvent() const {
    ...
    if (random < 90)  return EventType::CORRUPTION_SCANDAL;
...
void KingdomEvent::executeEvent(EventType type, Population& pop,
    ...
    cout << "\nPress Enter to acknowledge this event...";
    cin.ignore();
    cin.get();
}
...
void KingdomEvent::applyEffects(EventType type, Population& pop,
    ...
    case EventType::CORRUPTION_SCANDAL:
        cout << "MAJOR CORRUPTION SCANDAL!\n";
